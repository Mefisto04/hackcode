...
export const reverseLinkedList: Problem = {
	...
	problemStatement: `<p class='mt-3'>Given the head of a singly linked list, reverse the list, and return <em>the reversed list</em>.</p>
	`,
	examples: [
		{
			id: 0,
	...
	constraints: `<li class='mt-2'>The number of nodes in the list is the range [0, 5000].</li>
<li class='mt-2'>-5000 <= Node.val <= 5000</li>`,
